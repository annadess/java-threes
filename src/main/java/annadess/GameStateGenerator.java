...
public class GameStateGenerator {
	...
	/**
	 * Returns a new {@code GameState} object with a randomized board, and a
	 * random "next" value from 1 to 3. The stored "next" value represents the
	 * next number which will appear on the board.
	 * 
	 * @return a new {@code GameState} object with a randomized board, and a
	 *         random "next" value from 1 to 3
	 */
	...
	/**
	 * Returns a number between 1 to 3. Intended to be used as a new stored next
	 * value for the {@code GameState} object passed as the parameter, since the
	 * value returned depends on the game board's contents. (a design decision
	 * to make the game feel fairer and more accessible)
	 * 
	 * @param currentGameState
	 *            the {@code GameState} object that the returned value depends
	 *            on
