...
/**
 * Class that contains operators for transforming the {@code GameState}s. These
 * are used when the player moves the numbers of the board up, down, left or
 * right. With each new movement another number is added and another is
 * generated for the next move.
 * 
 * @author annadess
 */
public class GameStateOperator {
	...
	/**
	 * Moves the numbers on the board of the specified {@code GameState} to the
	 * right.
	 * 
	 * @param gs
	 *            the specified {@code GameState}
	 */
	...
	/**
	 * Moves the numbers on the board of the specified {@code GameState}
	 * downwards.
	 * 
	 * @param gs
	 *            the specified {@code GameState}
